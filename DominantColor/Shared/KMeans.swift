...
func kmeans<T : ClusteredType>(
    ...
    var centroids = points.randomValues(seed: seed, num: k)
    ...
    return Zip2Sequence(_sequence1: centroids, _sequence2: clusterSizes).map { Cluster(centroid: $0, size: $1) }
}
...
private func randomNumberInRange(_ range: CountableRange<Int>) -> Int {
